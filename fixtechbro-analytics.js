(() => {
  ...
  const addStyles = () => {
    ...
    style.textContent = `
      ...
      .ftb-live-intro{padding:8px}.ftb-live-kicker{color:#ffc928;font-size:.64rem;font-weight:950;letter-spacing:1.5px;text-transform:uppercase}.ftb-live-title{font-size:clamp(1.35rem,2.4vw,2rem);font-weight:950;line-height:1;margin:6px 0}.ftb-live-copy{color:#9fb0c2;font-size:.76rem;max-width:390px}
      ...
      .ftb-live-number{font-size:clamp(1.9rem,3.4vw,2.7rem);font-weight:1000;letter-spacing:-1px;color:#ffc928;line-height:1}.ftb-live-label{display:block;margin-top:6px;font-size:.68rem;font-weight:850;color:#d5dfeb;text-transform:uppercase;letter-spacing:.8px}.ftb-live-status{font-size:.59rem;color:#8fa2b6;margin-top:6px}.ftb-live-dot{display:inline-block;width:6px;height:6px;border-radius:50%;background:#38d39f;margin-right:5px;box-shadow:0 0 0 4px rgba(56,211,159,.08)}
